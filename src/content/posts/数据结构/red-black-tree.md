...
红黑树是[[bst-avl.md|二叉排序树（BST）]]的一种，查找过程与 BST 完全相同。插入和删除需要在 BST 操作后通过**颜色调整**和**旋转**来维持五条性质。
...
这种情况需要根据新结点、父结点、祖父结点的相对位置，进行 LL/RR/LR/RL 旋转（旋转方法与 [[bst-avl.md|AVL 树]] 相同），然后染色。
...
- [[bst-avl.md|二叉排序树与平衡二叉树]] — 红黑树的基础（BST 性质）与 AVL 对比
- [[tree-basics.md|树与二叉树基础]] — 二叉树定义与存储结构
