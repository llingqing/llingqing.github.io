...
> **核心性质**：对 BST 进行[中序遍历](./binary-tree-traversal.md)，得到的是递增有序序列。这一性质是 BST 所有应用的基础。
...
> 这是 AVL 树与 [红黑树](./red-black-tree.md) 对比时的关键区别之一：AVL 删除需要 O(log n) 次旋转，而红黑树删除最多 3 次旋转。
...
AVL 与 [红黑树](./red-black-tree.md) 的详细对比见红黑树页面。

---

## 关联页面

- [树与二叉树基础](./tree-basics.md) — 二叉树定义与性质
- [二叉树的遍历与线索化](./binary-tree-traversal.md) — BST 的中序递增序列性质
- [红黑树](./red-black-tree.md) — AVL 的"表兄弟"，性能对比
