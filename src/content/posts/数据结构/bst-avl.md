...
> **核心性质**：对 BST 进行[[binary-tree-traversal.md|中序遍历]]，得到的是递增有序序列。这一性质是 BST 所有应用的基础。
...
> 这是 AVL 树与 [[red-black-tree.md|红黑树]] 对比时的关键区别之一：AVL 删除需要 O(log n) 次旋转，而红黑树删除最多 3 次旋转。
...
AVL 与 [[red-black-tree.md|红黑树]] 的详细对比见红黑树页面。

---

## 关联页面

- [[tree-basics.md|树与二叉树基础]] — 二叉树定义与性质
- [[binary-tree-traversal.md|二叉树的遍历与线索化]] — BST 的中序递增序列性质
- [[red-black-tree.md|红黑树]] — AVL 的"表兄弟"，性能对比
