...
**遍历**（Traversal）是指按照某种规则访问树中所有结点一次且仅一次的过程。二叉树的基础定义和存储结构已在 [[tree-basics|树与二叉树基础]] 中介绍。
...
> 层序遍历需要借助队列实现，详见 [[queue.md|队列（Queue）]]。
...
- [[tree-basics.md|树与二叉树基础]] — 二叉树的定义与存储结构
- [[stack.md|栈（Stack）]] — 非递归遍历的辅助结构
- [[queue.md|队列（Queue）]] — 层序遍历的辅助结构
- [[bst-avl.md|二叉排序树与平衡二叉树]] — 中序遍历的 BST 递增性质
